...
<template>
  <div v-if="infoOpen" class="info">
    <div>
      ...
      Kaynak:  <a class="link" href="https://github.com/halilkaya/wordle-tr">GitHub</a>
      </p>
      <p>
  ...
  <header>
    <div>
      ...
      <a class="button" href="https://github.com/halilkaya" target="_blank">
      ...
      <a class="button" href="https://twitter.com/halilkaya" target="_blank">
        <svg class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
